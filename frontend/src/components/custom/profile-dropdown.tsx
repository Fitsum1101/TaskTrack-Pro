...
import { Settings, LogOut, User2, Bell, Shield } from 'lucide-react';
				...
				<Button variant="ghost" size="icon" className="rounded-full">
					...
					>
						<Avatar className="size-8 cursor-pointer">
							<AvatarImage src={'/placeholder.svg'} alt={'alt'} />
			...
			<AnimatePresence>
				<DropdownMenuContent align="end" className="w-56">
					...
					<div className="px-2 py-1.5">
						<p className="text-sm font-semibold text-foreground">lema</p>
